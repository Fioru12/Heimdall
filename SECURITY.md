...
This project is designed for **local development and testing environments only**.
Do not expose the API server or active response module to untrusted networks without proper hardening.
